...
export const Home = () => {
  ...
  const filteredRestaurants = useMemo(() => {
    return restaurants.filter((r) => {
      ...
      const matchLocation =
        selectedLocation === "All" || r.city === selectedLocation;
    ...
    <div className="min-h-screen bg-slate-50 pb-20" id="home-view-container">
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            Book table seating at premier rated local hotspots and publish
            review ratings directly on our connected platform.
          </motion.p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-3xl border border-slate-100 p-5 shadow-sm flex items-center gap-4">
            ...
            <div>
              ...
              <span className="text-[11px] text-slate-505 font-semibold mt-1 block">
                Over 800+ consumer feedback reviews
              </span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl border border-slate-100 p-5 shadow-sm flex items-center gap-4">
            ...
            <div>
              ...
              <span className="text-[11px] text-slate-505 font-semibold mt-1 block">
                Automatic check-in confirmed tickets
              </span>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8 pb-5 border-b border-slate-100">
          <div>
            ...
            <p className="text-slate-505 text-xs mt-0.5 font-semibold">
              Choose from the finest culinary destinations
            </p>
          </div>

          {/* Quick pills categories */}
          <div
            className="flex items-center gap-1.5 overflow-x-auto max-w-full pb-1 pointer-smooth scrollbar-none"
            id="cuisine-pills"
          >
        ...
        {isLoading ? (
          ...
          >
            ...
            <p className="text-zinc-500 text-sm font-semibold">
              Updating curated listings catalog...
            </p>
          </div>
        ) : (
            ...
            {filteredRestaurants.length > 0 ? (
              ...
              >
                ...
                <p className="text-zinc-500 text-xs leading-relaxed max-w-sm mx-auto mb-6">
                  Try broadening your keyword search, selecting another cuisine
