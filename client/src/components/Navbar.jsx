          ...
          <nav className="hidden md:flex items-center gap-6" id="desktop-nav">
            ...
            {currentUser ? (
              ...
              <button
                ...
                className="text-sm font-semibold text-slate-600 transition-all py-1.5 px-3 rounded-xl hover:text-indigo-600 hover:bg-slate-50 cursor-pointer flex items-center gap-1.5"
          ...
          >
            ...
            {currentUser ? (
              ...
              >
                ...
                <button
                  onClick={logout}
                  className="p-2 bg-slate-100 hover:bg-rose-50 hover:text-rose-600 text-slate-500 rounded-xl border border-slate-200 hover:border-rose-200 transition-all cursor-pointer flex items-center justify-center"
              ...
              >
                ...
                <button
                  ...
                  className="text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-700 transition-all py-2.5 px-4 rounded-xl shadow-sm cursor-pointer"
        ...
        {isOpen && (
          ...
          >
            <div className="px-4 pt-3 pb-5 space-y-2">
              ...
              {currentUser ? (
                <div
                  className="pt-4 mt-4 border-t border-zinc-200 px-3 flex flex-col gap-3"
                  onClick={handleOpenProfileModal}
                >
                ...
                <div className="pt-4 mt-4 border-t border-zinc-200 px-3 grid grid-cols-2 gap-2">
                  <button
                    onClick={() => {
                      setIsOpen(false);
                      openAuthModal("login");
                  ...
                  <button
                    ...
                    className="py-2.5 px-3 bg-indigo-600 hover:bg-indigo-700 font-bold text-white text-xs rounded-xl transition cursor-pointer"
                  >
                    Create Account
                  </button>
                </div>
