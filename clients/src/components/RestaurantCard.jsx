      ...
      <div className="p-5 flex-1 flex flex-col justify-between">
        <div>
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-slate-400 text-xs font-medium">({restaurant.ratingCount})</span>
            </div>
          ...
          <div className="flex items-center gap-1 text-slate-500 mb-3">
            ...
            <span className="text-xs font-medium truncate">{restaurant.location}</span>
          </div>
        ...
        <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
          <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">
            Opening: {restaurant.openingHours.split(' - ')[0]}
          </span>
          <Link
